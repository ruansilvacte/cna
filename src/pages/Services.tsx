...
export default function Services() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SeoHead slug="/services" fallbackTitle="Professional Cleaning Services, WeHome Cleaning" />
      <Header />
      ...
      <section className="w-full pt-36 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            From Airbnb turnovers to deep cleaning, 5-star execution across Charlotte, Huntersville, and Waxhaw.
          </motion.p>
          <motion.div
      ...
      <section className="w-full px-6 pt-16 pb-4">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            className="flex items-start gap-4 rounded-2xl border border-border/60 bg-card/60 backdrop-blur-sm px-6 py-5 shadow-sm"
          >
            <div
              className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center"
              style={{ background: "hsl(var(--brand-pink) / 0.12)" }}
            >
              <ShieldCheck className="w-5 h-5" style={{ color: "hsl(var(--brand-pink))" }} />
            </div>
            <div>
              <p className="text-[11px] font-bold uppercase tracking-[0.25em] mb-1.5 text-muted-foreground">
                Safety & Insurance Notice
              </p>
