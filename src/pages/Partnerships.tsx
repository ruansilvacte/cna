...
const partners = [
  ...
  {
    name: "Nextdoor",
    description: "Trusted by local communities across Charlotte Metro. Our presence on Nextdoor connects us with homeowners who value reliability, quality, and neighborhood trust.",
    icon: Users,
...
export default function Partnerships() {
  return (
    <div className="min-h-screen bg-background">
      <SeoHead slug="/partnerships" fallbackTitle="Partnerships, WeHome Cleaning" />
      <Header />
