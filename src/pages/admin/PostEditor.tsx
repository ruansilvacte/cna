        ...
        >
          {imageUrl && (
            <div className="w-full h-64 md:h-80 relative overflow-hidden">
              <img loading="lazy" decoding="async" src={imageUrl} alt={title} className="w-full h-full object-cover" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-card rounded-2xl border border-border/50 shadow-sm p-5 space-y-3">
              ...
              {imageUrl && (
                <img loading="lazy" decoding="async" src={imageUrl} alt="" className="w-full h-32 object-cover rounded-xl" />
              )}
