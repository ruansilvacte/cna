...
const benefits = [
  ...
  },
  {
    ...
    description: "Join a close-knit team where respect and communication come first.",
  },
];
...
export default function Careers() {
  return (
    <div className="min-h-screen bg-background">
      <SeoHead slug="/careers" fallbackTitle="Careers, WeHome Cleaning" />
      <Header />
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            Structure, growth, and a team that values your contribution, join WeHome Cleaning.
          </motion.p>
        </div>
      </section>
