...
const highlights = [
  {
    icon: MapPin,
    text: "100+ ZIP codes covered, from Charlotte to Waxhaw",
  },
  {
    icon: ClipboardCheck,
  ...
  {
    icon: HeartHandshake,
    text: "Founded in 2023, built on trust, efficiency & heart",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden">
              <img
                ...
                alt="Premium living space cleaned by WeHome Cleaning"
          ...
          <div className="flex flex-col">
            ...
            >
              WeHome Cleaning is a professional cleaning company based in Charlotte, Florida, recognized for operational excellence and commitment to elevated quality standards. Founded and our model is driven by efficiency, consistency, and rigorous attention to detail, delivering superior results every time.
            </motion.p>
