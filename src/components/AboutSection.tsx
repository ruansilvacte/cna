        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="rounded-3xl overflow-hidden h-56">
                  <img loading="lazy" decoding="async" src={images[0]} alt="Clean floor" className="w-full h-full object-cover" />
                </div>
                <div className="rounded-3xl overflow-hidden h-72">
                  <img loading="lazy" decoding="async" src={images[1]} alt="Clean bedroom" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="space-y-4 pt-8">
                <div className="rounded-3xl overflow-hidden h-72">
                  <img loading="lazy" decoding="async" src={images[2]} alt="Clean bathroom" className="w-full h-full object-cover" />
                </div>
                <div className="rounded-3xl overflow-hidden h-56">
                  <img loading="lazy" decoding="async" src={images[3]} alt="Clean table" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
            ...
            <motion.div
              ...
              style={{ background: "linear-gradient(135deg, hsl(var(--brand-pink) / 0.95), hsl(var(--brand-pink-soft) / 0.9))" }}
          ...
          <div>
            ...
            >
              <span className="text-xl" style={{ color: "hsl(var(--brand-pink))" }}>✦</span>
              <span className="text-sm md:text-base font-semibold uppercase tracking-[0.25em]" style={{ color: "hsl(var(--brand-pink))" }}>
                About Us
              </span>
            </motion.div>
            ...
            >
              ...
              <span className="bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, hsl(var(--brand-pink)), hsl(var(--brand-pink-soft)), hsl(210 80% 55%))" }}>
                trust & care
              </span>
            </motion.h2>
              ...
              {stats.map((stat, i) => {
                ...
                return (
                  <div key={i} className="rounded-2xl p-4 text-center border border-border/60" style={{ background: "hsl(210 30% 96% / 0.6)" }}>
                    <Icon className="w-5 h-5 mx-auto mb-2" style={{ color: "hsl(var(--brand-pink))" }} strokeWidth={1.8} />
