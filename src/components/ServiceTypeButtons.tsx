  ...
  return (
    <section className="w-full pt-10 pb-6 md:pt-14 md:pb-10 px-4 bg-[hsl(210_20%_96%)]">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Cleaning <em className="not-italic" style={{ color: "hsl(var(--brand-pink))" }}>built around your space</em>
        </motion.h2>
        <motion.p
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{ background: "linear-gradient(135deg, hsl(var(--brand-pink) / 0.08), transparent 60%)" }}
                />
                ...
                <div className="relative flex items-start justify-between mb-5">
                  ...
                  >
                    <Icon className="w-6 h-6" style={{ color: "hsl(var(--brand-pink))" }} />
                  </div>
                  <ArrowRight
