  ...
  return (
    ...
    >
      <nav className="w-full bg-white shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 py-1 md:py-1.5">
          {/* Logo */}
          <Link to="/" className="flex items-center flex-shrink-0">
            <img fetchPriority="high" src={logo} alt="WeHome Cleaning" className="h-14 md:h-16 w-auto" />
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4 flex-shrink-0">
            <Link
              to="/quote"
              className="px-7 py-2.5 rounded-full text-[0.75rem] font-semibold tracking-[0.1em] transition-all duration-300 hover:-translate-y-0.5"
              style={{
            ...
            >
              ...
              <div className="flex flex-col gap-3 mt-3">
                <Link
                  to="/quote"
                  onClick={() => setMobileOpen(false)}
                  className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-full text-base font-semibold text-white"
                  style={{
                    background: "var(--gradient-blue)",
                    fontFamily: "var(--font-body)",
                  }}
