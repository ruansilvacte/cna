  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(circle at 20% 50%, hsl(var(--brand-pink) / 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 20%, hsl(var(--brand-pink-soft) / 0.08) 0%, transparent 40%)",
        }}
      />
